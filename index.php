...
<body>
            ...
            <?php
                ...
                ?>
                            <tr>
                                ...
                                <?php include('animals/view_delete_animal.php'); ?>
                                <?php include('animals/view_edit_animal.php'); ?>
                            </tr>
                <?php 
                        }
                    }
    ...
    <div id="footer" class="text-center fw-bold text-dark"  style = "background-color:pink;">
        <p>Developed By: </p>
        <p>Mildred Escudero</p>
        <p>Melriss Estrada</p>
    </div>

    <?php include('animals/view_add_animal.php'); ?>
